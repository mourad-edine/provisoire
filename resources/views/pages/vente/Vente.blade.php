    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <td>${achatUnite.checked ? 'non conditionné' : (cgt_checkbox.checked ? '<span class="text-success">oui</span>(non consigné)' : '<span class="text-danger">non</span>(8000 ar / CGT)')}</td>
